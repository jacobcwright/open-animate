...
When using AI-generated media (images, video, audio), layer them into the scene structure. See the full [Working with Media](/guides/media) guide for generation commands and detailed examples.
...
<AbsoluteFill>
  ...
  <TransitionSeries>
    {/* Scenes — music plays across all of them */}
  </TransitionSeries>
</AbsoluteFill>
```
