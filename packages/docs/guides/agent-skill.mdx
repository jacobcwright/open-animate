...
The `animate-skill/` directory is an agent skill — a structured set of references, templates, and workflow instructions that any coding agent can use to produce professional motion graphics.
