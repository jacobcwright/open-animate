---
title: Agent Skill
description: Teach AI agents to compose motion graphics with Open Animate
---
...
An agent skill is a structured set of references, templates, and workflow instructions that an AI coding agent (like Claude) can use to produce high-quality output in a specific domain. The Open Animate skill teaches agents the workflow, animation presets, composition patterns, and best practices.

## Prerequisites

The Open Animate skill builds on top of **Remotion skills** for core Remotion API knowledge:

```bash
npx skills add remotion-dev/skills
```

Open Animate adds premium animation presets, components, and a workflow CLI on top of Remotion's foundations.
