...
description: Hosted infrastructure for asset generation, cloud rendering, and billing
---

Open Animate is **open-core** — everything is Apache 2.0 and self-hostable. The hosted platform at `api.oanim.dev` provides managed infrastructure so you don't have to run your own.
